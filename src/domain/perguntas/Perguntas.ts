...
export const PERGUNTAS_DEFAULTS: Perguntas = {
  abertura: {
    ...
    intro:
      "As dúvidas que mais chegam antes de uma primeira conversa: sobre a análise, sobre a orientação profissional e de carreira, e sobre como o atendimento funciona. Ele é on-line, uma vez por semana, em português ou em inglês, para todo o Brasil e para quem mora no exterior.",
  },
