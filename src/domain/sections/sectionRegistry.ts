...
// type → component map lives in `view/` (components can't be imported here).
// ---------------------------------------------------------------------------

export type SectionType = "pillars" | "about" | "cosmos" | "voices" | "symbols" | "contact";
